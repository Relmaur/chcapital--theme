...
$fidEmail = OptionsPage::get('division_fiduciaria_email');
$fidPhone = OptionsPage::get('division_fiduciaria_phone');
$finEmail = OptionsPage::get('division_financiera_email');
...
<footer id="colophon" class="site-footer" role="contentinfo">
            ...
            <div class="footer-contact">
                <div class="divisions flex flex-col gap-5">
                    <div class="division flex flex-col gap-2">
                        ...
                        <?php if ($finEmail) : ?>
                            <a class="footer-contact__link" href="mailto:<?php echo esc_attr($finEmail); ?>">
                                ...
                                <?php echo esc_html($finEmail); ?>
                            </a>
                        <?php endif; ?>
                        <?php if ($finPhone) : ?>
                            <a class="footer-contact__link" href="tel:<?php echo esc_attr($finPhone); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                    <path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" />
                                </svg>
                                <?php echo esc_html($finPhone); ?>
                            </a>
                        <?php endif; ?>
                    </div>
                    <div class="division flex flex-col gap-2">
                        ...
                        <?php if ($fidEmail) : ?>
                            <a class="footer-contact__link" href="mailto:<?php echo esc_attr($fidEmail); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                    <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
                                    <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
                                </svg>
                                <?php echo esc_html($fidEmail); ?>
                            </a>
                        <?php endif; ?>
                        <?php if ($fidPhone) : ?>
                            <a class="footer-contact__link" href="tel:<?php echo esc_attr($fidPhone); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                    <path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" />
                                </svg>
                                <?php echo esc_html($fidPhone); ?>
                            </a>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="footer-bottom bg-primary">
        <div class="section-container--sm py-4 flex flex-col-reverse sm:flex-row items-start sm:items-center justify-between gap-3">
