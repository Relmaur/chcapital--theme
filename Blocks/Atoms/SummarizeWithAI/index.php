    ...
    <div x-show="open"
        ...
        <?php foreach ($ai_models as $model) : ?>
            <a href="<?php echo esc_url($model['url']); ?>"
                ...
                class="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-700 hover:border-blue-300 hover:text-blue-700 hover:bg-blue-50 transition-all no-underline">
                <span style="color: <?php echo esc_attr($model['color']); ?>">
                    <?php echo $model['icon']; ?>
                </span>
                <?php echo esc_html($model['name']); ?>
                <svg class="w-3 h-3 ml-auto text-gray-300" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
