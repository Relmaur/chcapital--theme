...
<?php
    case 'icon': ?>
        <a href="<?php echo esc_url($link['url']); ?>" class="flex items-center gap-2 py-2 px-4 border border-gray-300 w-fit rounded-md<?php echo ' ' . esc_attr($classes); ?>" target="<?php echo esc_attr($link['target']); ?>" rel="noopener">
