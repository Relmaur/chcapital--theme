...
?>
<section class="contact-cta ch-section" style="--background-url: url('<?php echo get_site_url() ?>/wp-content/uploads/2026/05/ch-contact-us-bg-image.webp')" id="contact-cta">
