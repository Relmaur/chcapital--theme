...
class ContactCta extends MetaBlock
{
    ...
    protected function registerMetaboxes(): void
    {
        new Metabox([
            ...
            'screens' => ['page-credito-pyme.php', 'page-arrendamiento-puro.php', 'page-fideicomisos.php', 'page-credito-de-nomina.php', 'page-escrow.php', 'page-nosotros.php', 'page-multimedia.php'],
            'fields'  => [
                [
